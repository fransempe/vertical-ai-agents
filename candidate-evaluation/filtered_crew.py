...
from agents import (
    ...
    create_filtered_data_extractor_agent,
...
from tasks import (
    ...
    create_filtered_extraction_task,
...
def create_filtered_data_processing_crew(jd_interview_id: str):
    ...
    comparison_task = create_candidate_job_comparison_task(
        data_processor, extraction_task, analysis_task, job_analysis_task
    )
    processing_task = create_processing_task(
        data_processor, extraction_task, analysis_task, job_analysis_task, comparison_task
    )
