...
def create_data_processing_crew():
    ...
    # Crear crew
    crew = Crew(
        agents=[extractor_agent, analyzer_agent, job_analyzer_agent, processor_agent, email_agent],
        tasks=[extraction_task, analysis_task, job_analysis_task, comparison_task, processing_task, email_task],
